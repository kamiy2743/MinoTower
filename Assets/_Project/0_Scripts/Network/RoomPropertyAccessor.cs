...
namespace MT
{
    public class RoomPropertyAccessor : MonoBehaviourPunCallbacks, IStaticAwake
    {
        public static RoomPropertyAccessor Instance => _instance;
        private static RoomPropertyAccessor _instance;
